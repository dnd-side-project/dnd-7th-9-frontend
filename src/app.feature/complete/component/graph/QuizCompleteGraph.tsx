...
export default function QuizCompleteGraph({
		...
		datasets: [
			{
				...
				data: [50, 50 - addPercentageCreate - createScore, addPercentageCreate + createScore],
				...chartCommonStyle,
			},
		],
	};
		...
		datasets: [
			{
				...
				data: [addPercentageSolve + solveScore, 50 - addPercentageSolve - solveScore, 50],
				...chartCommonStyle,
			},
		],
	};
	...
	return (
		<div className="grid place-items-center mt-[31px]">
			<div>{addPercentageCreate + addPercentageSolve > 0 ? <RunningPersonIcon /> : <PersonIcon />}</div>
